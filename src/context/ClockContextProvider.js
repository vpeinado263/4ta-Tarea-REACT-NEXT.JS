...
//Paso 3 - Definir la prop a despachar (aka El paquete)
   const ClockContextProvider = ({ children }) => {  
    const [clocks, setClocks] = useState([
     { id: 1, title: "Abraham-Louis Breguet", description: "Uno de los pioneros en relojes de precisión." },
     { id: 2, title: "Christiaan Huygens", description: "Inventor del primer reloj de péndulo." },
     { id: 3, title: "Daniel Quare", description: "Inventor del reloj de repetición de cuartos." },
     { id: 4, title: "John Harwood", description: "Pionero en relojes automáticos." },
     { id: 5, title: "Franz Ketterer", description: "Conocido por sus contribuciones en relojes de cuco." }
   ]);
  ...
  return (
  <ClockContext.Provider value={{ clocks}}>
    {children}
